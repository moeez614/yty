...
const Format = () => {
    ...
    const [wakhai , setwakhai]= useState(false)
    ...
    return (
        <div>
            ...
            <section className='sab-to-uta'>
                ...
                <div>
                    <button onClick={() => {setwakhai(!wakhai)
                        setblur(!blur)
                    }} className='preview uni'><i className="fa-regular fa-eye"></i>Preview</button>
            ...
            <div className={!blur ? 'blur' : 'bg-white ek-masla'}>
            ...
            {
                wakhai &&
                <section className="report-right sanjha wakhai" ref={reportRef}>
                        <div className="format-header">
                            <div className='format-logo'>
                                <img src={whitelogo} alt="logo" width={100} />
                                <h4>Allied Hospital <br />
